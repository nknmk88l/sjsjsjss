...
game:GetService("StarterGui"):SetCore("SendNotification", {
  Title = "sheimHuB",
  Text = "sheimHuB已重做 本来想搞成检测服务器ID的 后面还是因为麻烦 就不搞了",
  Icon = "rbxassetid://18941716391",
  Duration = 1,
  Callback = bindable,
  Button1 = "此脚本是永久免费的",
...
RevenantLib:Notification({
  Text = "sheimHuB作者: 神秘\u{e000}",
  Duration = 6,
})
wait(1)
RevenantLib:Notification({
  Text = "sheimHuB脚本帮助者: lEAI⚜️\u{e000}",
  Duration = 6,
})
wait(1)
RevenantLib:Notification({
...
local UILibrary = loadstring(game:HttpGet([[https://raw.githubusercontent.com/xiaopi77/xiaopi77/main/%E7%9A%AE%E8%84%9A%E6%9C%ACUI%E6%BA%90%E7%A0%81.lua]]))():new("sheimHuB′脚本")
...
PlayerInfoSection:Toggle("开/关皮脚本用户名称显示", "Toggle", false, function(enabled)
  ...
  if enabled then
    ...
    while XM do
      ...
      textLabel.Text = "尊贵的sheimHuB用户: " .. game.Players.LocalPlayer.DisplayName
...
AuthorInfoSection:Label("sheimHuB")
AuthorInfoSection:Label("永不跑路的脚本")
AuthorInfoSection:Label("作者: 神秘")
AuthorInfoSection:Label("sheimHuBQQ主群: 894995244")
AuthorInfoSection:Label("十分感谢lEAI⚜️对我的支持与帮助")
AuthorInfoSection:Label("给我提供了许多的功能源码")
AuthorInfoSection:Label("谢谢您的支持与帮助^ω^")
AuthorInfoSection:Button("复制sheimHuBQQ主群", function()
...
GeneralSection:Toggle("开启杀戮光环", "Toggle", false, function(enabled)
  ...
  if enabled then
    ...
    local function GetHumanoid(model)
      ...
      if isModel then
        isModel = model or GetCharacter(model)
      else
        goto label_7	
      end
      if isModel then
        local humanoidType = "Humanoid"
        return isModel:FindFirstChildWhichIsA(humanoidType) 
      end
    end
...
GeneralSection:Toggle("上帝模式", "No Description", false, function(enabled)
  ...
  if enabled then
    local localPlayer = game:GetService("Players").LocalPlayer
    (localPlayer.Character and localPlayer.Character.HumanoidRootPart):Clone().Parent = localPlayer.Character
  else
...
GeneralSection:Toggle("靠近自动攻击(需要拿起武器)", "Toggle", false, function(enabled)
  ...
  if enabled then
    ...
    local function r9_585(r0_590)
      ...
      local r1_590 = r0_590:IsA("Model")
      if r1_590 then
        r1_590 = r0_590 or r8_585(r0_590)
      else
        goto label_7	
      end
      if r1_590 then
        local r4_590 = "Humanoid"
        ... = r1_590:FindFirstChildWhichIsA(r4_590) 
      end
    end
...
GeneralSection:[textboxMethod](textboxLabel, "text", "输入", function(webhookUrl)
...
dropdownMethod = "Dropdown"
dropdownLabel = "相机"
GeneralSection:[dropdownMethod](dropdownLabel, "Camera", {
  "经典",
  "第一人称"
}, function(cameraMode)
...
textboxMethod = "Textbox"
textboxLabel = "设置旋转速度"
SpinRangeSection:[textboxMethod](textboxLabel, "TextBoxFlag", "输入", function(speed)
...
textboxMethod = "Textbox"
textboxLabel = "范围大小设置"
SpinRangeSection:[textboxMethod](textboxLabel, "HitboxSize", "输入", function(size)
...
SpinRangeSection:[textboxMethod](textboxLabel, "HitboxTransparency", "输入", function(transparency)
  
  getgenv().HitboxTransparency = transparency
end)
dropdownMethod = "Dropdown"
dropdownLabel = "选择范围颜色"
SpinRangeSection:[dropdownMethod](dropdownLabel, "Hitbox", {
  "Really blue",
  "Really black",
  "Really red",
  "Really pink",
...
local playerDropdown = TeleportSection:[dropdownMethod](dropdownLabel, "Dropdown", PlayerConfig.dropdown, function(selectedPlayer)
...
r68_0:Toggle("循环甩飞", "AutoFling", false, function(r0_53)
...
r68_0:Toggle("开启指定自瞄目标", "Aimbot", false, function(r0_462)
...
local r74_0 = "Textbox"
r74_0 = "你要说的话"
r71_0:[r74_0](r74_0, "TextBoxFlag", "填写你想要说的话", function(r0_664)
  
  bin.message = r0_664
end)
r74_0 = "Textbox"
r74_0 = "说话次数"
r71_0:[r74_0](r74_0, "TextBoxFlag", "输入说话次数", function(r0_683)
  ...
  r112_0.RenderStepped:Connect(function()
    ...
    if r1_694 and r2_694 and 0 < r2_694.Health then
      ...
      if getgenv().ShowTracer then
        local r9_694 = r5_693
        local r10_694 = getgenv().TracerStart
        if r10_694 == "Bottom" then
          r10_694 = Vector2.new(r113_0.ViewportSize.X / 2, r113_0.ViewportSize.Y) or Vector2.new(r113_0.ViewportSize.X / 2, r113_0.ViewportSize.Y / 2)
        else
          goto label_268	
        end
        r9_694.From = r10_694
...
local r120_0 = "Slider"
r120_0 = "圈圈自瞄厚度"
r117_0:[r120_0](r120_0, "thickness", 2, 0, 10, false, function(r0_144)
...
r120_0 = "Slider"
r120_0 = "圈圈自瞄大小"
r117_0:[r120_0](r120_0, "Size", 50, 0, 100, false, function(r0_642)
...
r120_0 = "Slider"
r120_0 = "圈圈自瞄透明度"
r117_0:[r120_0](r120_0, "Transparency", 5, 0, 10, false, function(r0_473)
...
r120_0 = "Slider"
r120_0 = "圈圈自瞄距离"
r117_0:[r120_0](r120_0, "distance", 200, 10, 500, false, function(r0_705)
  
  AimConfig.distance = r0_705
end)
r120_0 = "Dropdown"
r120_0 = "选择圈圈自瞄颜色"
local r118_0 = r117_0:[r120_0](r120_0, "Dropdown", {
  "红色",
  "蓝色",
  "黄色",
  "绿色",
...
r121_0 = "选择圈圈自瞄部位"
local r119_0 = r117_0:[r121_0](r121_0, "Dropdown", {
  "头部",
  "脖子",
  "躯干",
  "左臂",
...
local r122_0 = "Slider"
r122_0 = "预判距离"
r117_0:[r122_0](r122_0, "distance", 100, 10, 500, false, function(r0_276)
...
r122_0 = "Dropdown"
r122_0 = "圈圈自瞄优先模式"
r120_0 = r117_0:[r122_0](r122_0, "Priority Mode", {
  "Distance",
  "Crosshair",
  "Speed",
  "Smart"
...
r123_0 = "自瞄模式"
r121_0 = r117_0:[r123_0](r123_0, "Aim Mode", {
  "AI",
  "Function"
}, function(r0_119)
...
local r124_0 = "Slider"
r124_0 = "平滑度"
r117_0:[r124_0](r124_0, "Smoothness", 5, 0, 10, false, function(r0_524)
  
  AimConfig.smoothness = r0_524
end)
r124_0 = "Slider"
r124_0 = "自瞄速度"
r117_0:[r124_0](r124_0, "Aim Speed", 5, 0, 10, false, function(r0_209)
...
r124_0 = "Slider"
r124_0 = "动态FOV缩放比例"
r117_0:[r124_0](r124_0, "Dynamic FOV Scale", 1.5, 1, 3, false, function(r0_448)
...
r124_0 = "Slider"
r124_0 = "开火频率"
r117_0:[r124_0](r124_0, "Fire Rate", 10, 1, 20, false, function(r0_479)
  
  AimConfig.fireRate = r0_479
end)
r124_0 = "Slider"
r124_0 = "子弹延迟"
r117_0:[r124_0](r124_0, "Bullet Delay", 0.1, 0, 1, false, function(r0_710)
...
r128_0 = "音乐播放器"
r125_0:[r128_0](r128_0, "Textbox", "输入音乐ID", true, function(r0_310)
...
r134_0 = "模糊类型"
local r132_0 = r131_0:[r134_0](r134_0, "blurTypes", r36_0, function(r0_550)
  
  r41_0(r0_550)
end)
local r133_0 = {}
for r137_0, r138_0 in ipairs(r38_0) do
  table.insert(r133_0, r138_0.name)
end
local r136_0 = "Dropdown"
r136_0 = "模糊效果预设"
r134_0 = r131_0:[r136_0](r136_0, "presetNames", r133_0, function(r0_31)
...
local r137_0 = "Slider"
r137_0 = "模糊强度"
r131_0:[r137_0](r137_0, 1, 1, 50, BlurAmount, function(r0_124)
  
  BlurAmount = r0_124
end)
r137_0 = "Slider"
r137_0 = "模糊平滑度"
r131_0:[r137_0](r137_0, 0.1, 0.01, 1, BlurSmoothness, function(r0_255)
  
  BlurSmoothness = r0_255
end)
r137_0 = "Slider"
r137_0 = "模糊阈值"
r131_0:[r137_0](r137_0, 0.1, 0.01, 1, BlurThreshold, function(r0_249)
  
  BlurThreshold = r0_249
end)
r137_0 = "Slider"
r137_0 = "模糊持续时间"
r131_0:[r137_0](r137_0, 0.5, 0.1, 5, r30_0, function(r0_712)
  
  r30_0 = r0_712
end)
r137_0 = "Slider"
r137_0 = "模糊方向 X"
r131_0:[r137_0](r137_0, -1, 0, 1, r32_0.X, function(r0_93)
  
  r32_0 = Vector2.new(r0_93, r32_0.Y)
end)
r137_0 = "Slider"
r137_0 = "模糊方向 Y"
r131_0:[r137_0](r137_0, -1, 0, 1, r32_0.Y, function(r0_457)
  
  r32_0 = Vector2.new(r32_0.X, r0_457)
end)
r137_0 = "Slider"
r137_0 = "模糊区域 X1"
r131_0:[r137_0](r137_0, 0.5, 0, 1, r33_0[1], function(r0_126)
  
  r33_0[1] = r0_126
end)
r137_0 = "Slider"
r137_0 = "模糊区域 Y1"
r131_0:[r137_0](r137_0, 0.5, 0, 1, r33_0[2], function(r0_349)
  
  r33_0[2] = r0_349
end)
r137_0 = "Slider"
r137_0 = "模糊区域 X2"
r131_0:[r137_0](r137_0, 0.5, 0, 1, r33_0[3], function(r0_493)
  
  r33_0[3] = r0_493
end)
r137_0 = "Slider"
r137_0 = "模糊区域 Y2"
r131_0:[r137_0](r137_0, 0.5, 0, 1, r33_0[4], function(r0_262)
  
  r33_0[4] = r0_262
end)
r137_0 = "GetPropertyChangedSignal"
r137_0 = "CurrentCamera"
workspace:[r137_0](r137_0):Connect(function()
  
  local r0_161 = workspace.CurrentCamera
  if BlurEffectInstance and BlurEffectInstance.Parent then
    BlurEffectInstance.Parent = r0_161
  else
    r39_0(r0_161)
  end
end)
...
r137_0:Toggle("飞行", "Fly", false, function(r0_289)
  ...
  while true do
    if r44_0 ~= true then
      local r13_289 = r2_289.Health
      if r13_289 == 0 then
        ::label_284::
        task.wait()
        r13_289 = r7_289.l + r7_289.r
        if r13_289 == 0 then
          r13_289 = r7_289.f + r7_289.b
          if r13_289 ~= 0 then
            ::label_297::
            r13_289 = r10_289 + 0.5
            r10_289 = r13_289 + r10_289 / r9_289
            if r9_289 < r10_289 then
              r10_289 = r9_289
            end
          else
            r13_289 = r7_289.l + r7_289.r
            if r13_289 == 0 then
              r13_289 = r7_289.f + r7_289.b
              if r13_289 == 0 and r10_289 ~= 0 then
                r10_289 = r10_289 - 1
                if r10_289 < 0 then
                  r10_289 = 0
                end
        ...
        if r13_289 == 0 then
          ...
          if r13_289 ~= 0 then
            ::label_330::
            r12_289.velocity = (game.Workspace.CurrentCamera.CoordinateFrame.lookVector * (r7_289.f + r7_289.b) + game.Workspace.CurrentCamera.CoordinateFrame * CFrame.new((r7_289.l + r7_289.r), (r7_289.f + r7_289.b) * 0.2, 0).p - game.Workspace.CurrentCamera.CoordinateFrame.p) * r10_289
            r13_289 = {}
            r13_289.f = r7_289.f
            r13_289.b = r7_289.b
            r13_289.l = r7_289.l
            ...
            if r13_289 == 0 then
              r13_289 = r7_289.f + r7_289.b
              if r13_289 == 0 and r10_289 ~= 0 then
                r13_289 = (game.Workspace.CurrentCamera.CoordinateFrame.lookVector * (r8_289.f + r8_289.b) + game.Workspace.CurrentCamera.CoordinateFrame * CFrame.new((r8_289.l + r8_289.r), (r8_289.f + r8_289.b) * 0.2, 0).p - game.Workspace.CurrentCamera.CoordinateFrame.p) * r10_289
                r12_289.velocity = r13_289
              end
            else
              r13_289 = Vector3.new(0, 0, 0)
              r12_289.velocity = r13_289
            end
          end
        else
        ...
        r13_289 = game.Workspace.CurrentCamera.CoordinateFrame * CFrame.Angles(-math.rad(((r7_289.f + r7_289.b) * 50 * r10_289 / r9_289)), 0, 0)
        r11_289.cframe = r13_289
      else
        break
      end
    else
...
local r138_0 = r137_0:Label("当前速度:" .. r43_0)
spawn(function()
  
  while wait() do
    pcall(function()
      
      r138_0.Text = "当前速度:" .. r43_0
    end)
  end
end)
r137_0:Label("飞车")
...
r141_0 = "输入飞行速度"
r137_0:[r141_0](r141_0, "TextBoxfalg", "输入数字", function(r0_179)
  ...
  while true do
    ...
    wait()
    local r1_179 = Instance.new("BodyVelocity", game.Players.LocalPlayer.Character.HumanoidRootPart)
    local r2_179 = Instance.new("BodyGyro", game.Players.LocalPlayer.Character.HumanoidRootPart)
    r2_179.MaxTorque = Vector3.new(math.huge, math.huge, math.huge)
    r2_179.D = 5000
    r2_179.P = 50000
    r2_179.CFrame = game.Workspace.CurrentCamera.CFrame
    r1_179.MaxForce = Vector3.new(math.huge, math.huge, math.huge)
    r1_179.Velocity = game.Workspace.CurrentCamera.CFrame.LookVector * r0_179
  end
  goto label_81	
end)
...
r150_0:Toggle("自动挥舞", "AT", false, function(r0_283)
  
  if v or not v then
    getgenv().autoswing = r0_283
    while true do
      if not getgenv().autoswing then
        return 
      end
      local r1_283 = pairs
      for r4_283, r5_283 in r1_283(game.Players.LocalPlayer.Backpack:GetChildren()) do
        if r5_283:FindFirstChild("ninjitsuGain") then
          game.Players.LocalPlayer.Character.Humanoid:EquipTool(r5_283)
          break
        end
      end
      r1_283 = "swingKatana"
      local r2_283 = game:GetService("Players").LocalPlayer.ninjaEvent:FireServer(r1_283)
      wait()
    end
    return 
  else
...
r156_0:Toggle("禁用掉落伤害", "AJH", false, function(r0_51)
  ...
  _G.NoFallDamage = r0_51
  while wait(0.5) do
    local r1_51 = _G.NoFallDamage
    if r1_51 == true then
      r1_51 = game.Players.LocalPlayer.Character
      if r1_51 ~= nil then
        r1_51 = game.Players.LocalPlayer.Character:FindFirstChild("FallDamageScript") or nil
      else
        goto label_26	
      end
      if r1_51 then
